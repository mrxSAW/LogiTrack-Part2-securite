    ...
    <Box>
      ...
      <Paper sx={{padding: 3,maxWidth: 800,}}>
        <Box
          ...
          <Avatar sx={{ width: 90,height: 90,fontSize: 32, backgroundColor: 'primary.main', }} >
            {initials || '?'}
          </Avatar>
          ...
          <Box>
            ...
            <Typography color="text.secondary" sx={{ marginTop: 0.5,  marginBottom: 1, }} >
              {user?.email}
            </Typography>

            <Chip label={getRoleLabel(user?.role)} color={getRoleColor(user?.role)} />
        ...
        <Box
          sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr',sm: 'repeat(2, 1fr)',},
            gap: 3,
          }} >
          <Box>
